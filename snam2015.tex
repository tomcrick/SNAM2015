...
\thanks{This article is a substantially extended and revised version of the authors' ASONAM
  2014 papers~\citep{oatley+crick_asonam2014,oatley+crick_fosintsi2014},
  with an updated research and policy context, literature review and methodology, along with new data and analysis.}
}
...
the different link types, referring to Klerks' `third generation'
analysis, as well as a brief discussion of the potential UK policy
applications of this work.

\keywords{Gangs \and Gun crime \and Scale-free networks \and
Small-world networks \and Social distance \and Communities \and Crime policy}
...
\hline
 \multirow{2}{*}{Relationship} & \multicolumn{10}{l|}{Gang Membership
   Relationships} \\\cline{2-11}
 &  \multicolumn{1}{c|}{AA} &  \multicolumn{1}{c|}{BB} &  \multicolumn{1}{c|}{CC} &  \multicolumn{1}{c|}{DD} &  \multicolumn{1}{c|}{AB} &  \multicolumn{1}{c|}{AC} &  \multicolumn{1}{c|}{AD} & \multicolumn{1}{c|}{BC} & \multicolumn{1}{c|}{BD} & \multicolumn{1}{|c|}{CD} \\ 
\hline
...
\hline
 \multirow{2}{*}{Relationship} & \multicolumn{7}{l|}{Gang Membership
   Relationships} \\\cline{2-8}
 &  \multicolumn{1}{c|}{{\emph{a*}}} &  \multicolumn{1}{c|}{{\emph{b*}}} &  \multicolumn{1}{c|}{{\emph{c*}}} &  \multicolumn{1}{c|}{{\emph{ab*}}} &  \multicolumn{1}{c|}{{\emph{bc*}}} &  \multicolumn{1}{c|}{{\emph{ac*}}} &  \multicolumn{1}{c|}{{\emph{abc*}}} \\ 
\hline
